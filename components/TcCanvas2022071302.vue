  ...
  methods: {
    ...
    draw() {
      ...
      for (let i = 0; i < this.points.length; i++) {
        ...
        point.a = point.a + this.p5.random(20) * 0.01
        ...
        this.p5.fill(220 + this.p5.random(36), 120 + this.p5.random(30), 120 + this.p5.random(30))
        /* this.p5.ellipse(0, 0, point.r, this.p5.random(100)) */
        this.p5.ellipse(this.p5.random(40), this.p5.random(40), point.r, 20 + this.p5.random(100))
        this.p5.pop()
